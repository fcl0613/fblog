...
CREATE TABLE `blog`  (
  ...
  `preface` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '文章前言',
  ...
  `flag` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
INSERT INTO `blog` VALUES (2, '测试22', '达瓦的吗拉我的发你了啊', 'sdahdkad', 'moren.png', '原创', 46, 0, 0, 2, '2021-10-10 19:20:34', '2022-04-11 19:57:55');
...
INSERT INTO `blog` VALUES (25, 'dwda', NULL, 'dawdwadawdw', 'moren.png', '原创', 0, 0, 1, 2, '2022-04-16 08:53:42', '2022-04-16 08:53:42');
INSERT INTO `blog` VALUES (26, 'sdsd', 'dawdw', 'dawdwadwa', 'moren.png', '原创', 3, 0, 1, 2, '2022-04-16 08:55:35', '2022-04-16 08:55:35');
...
INSERT INTO `blog_tag_relation` VALUES (26, 1);
...
INSERT INTO `blog_tag_relation` VALUES (25, 2);
...
INSERT INTO `blog_tag_relation` VALUES (25, 3);
INSERT INTO `blog_tag_relation` VALUES (26, 3);
...
CREATE TABLE `comment`  (
  ...
  `nick_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `content` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '评论内容，不超200字',
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '评论者头像估计都是一样的',
  ...
  `create_time` datetime(0) NULL DEFAULT NULL,
  `parent_nick_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '评论父昵称冗余字段',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `comment` VALUES (20, 2, NULL, '测试一号机', 'sadasd@qq.com', '你好呀', '/blog/images/touxiang.jpg', 1, 0, '2022-04-16 10:48:18', NULL);
INSERT INTO `comment` VALUES (21, 2, 20, '测试二号机', '1397697356@qq.com', '你好呀', '/blog/images/touxiang.jpg', 1, 0, '2022-04-16 10:48:44', NULL);
INSERT INTO `comment` VALUES (22, 2, 21, '测试三号机', 'sadasd@qq.com', '我不好', '/blog/images/touxiang.jpg', 1, 0, '2022-04-16 10:53:25', '测试二号机');
INSERT INTO `comment` VALUES (23, 2, 22, '测试四号机', 'sadasd@qq.com', 'ceshi', '/blog/images/touxiang.jpg', 1, 0, '2022-04-16 11:06:13', '测试三号机');
